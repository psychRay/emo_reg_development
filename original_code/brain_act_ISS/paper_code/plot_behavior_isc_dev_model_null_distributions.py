...
def plot_one_condition(
    ...
    for model in [str(m) for m in args.models]:
        ...
        summary.append({
            ...
            "bootstrap_file": str(bootstrap_file) if bootstrap_file is not None else "",
            "plot_status": "plotted_single_model",
            "output_svg": str(out_svg),
            "output_png": str(out_svg.with_suffix(".png")) if not bool(args.no_png) else "",
        })
